...
| Brevo | Deliver authentication and workflow email | Recipient name, email address and message delivery metadata | European Union required; authoritative account/contract evidence pending | Contract performance and legitimate interest; production activation blocked until the DPA and account evidence confirm EU processing |
| 46elks | Deliver workflow SMS | Recipient name, telephone number and message delivery metadata | European Union required; authoritative account/contract evidence pending | Contract performance and legitimate interest; production activation blocked until contractual/account evidence confirms EU processing and subprocessors |

Brevo and 46elks placement is a production requirement, not a completed verification. Follow the evidence procedures in `docs/infrastructure-verification.md`; email or SMS production activation remains blocked until each provider's authoritative account and contractual evidence passes those checks.

...
export async function getConsentPresentation() { const context = await preConsentContext("getCurrentTerms"); const { readVerifiedReacceptanceContext } = await import("./consent-status"); return readVerifiedReacceptanceContext(context.userId); }
